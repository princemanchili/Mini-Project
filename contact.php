    ...
    <div class="container" style="margin-top:70px;">
            ...
            <div class="col-md-4">
                ...
                <p>
                   SVEC blood bank  <br>
					pedatadepalli<br>
					Tadepalligudem -534 101<br>
					West Godavari District <br>Andhrapradesh.
                </p>
                <p><i class="fa fa-phone"></i> 
                    <abbr title="Phone">P</abbr>: 93470 08646</p>
                <p><i class="fa fa-envelope-o"></i> 
                    <abbr title="Email">E</abbr>: <a href="#" >svecbloodbankin@gmail.com</a>
                </p>
