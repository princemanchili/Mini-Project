                ...
                <div class="panel panel-primary">
					...
					<?php
						if(isset($_POST["submit"]))
						{
								 ...
								 $sql="INSERT INTO request_blood(NAME,GENDER,BLOOD,BUNIT,CITY,PIN,RDATE,CNAME,EMAIL,CON1,CON2,REASON,CADDRESS)
								 VALUES('{$_POST["NAME"]}','{$_POST["GENDER"]}','{$_POST["BLOOD"]}','{$_POST["BUNIT"]}','{$_POST["CITY"]}','{$_POST["PIN"]}','{$_POST["RDATE"]}','{$_POST["CNAME"]}','{$_POST["EMAIL"]}','{$_POST["CON1"]}','{$_POST["CON2"]}','{$_POST["REASON"]}','{$_POST["CADDRESS"]}')";
									if($con->query($sql))
									{
