		    ...
		    <div class="col-xs-12 col-sm-12 col-md-6">
                <div class="panel panel-primary">
					...
					<form  name="frm" id="frm" >
						...
						<div class="form-group">
							<label class="control-label text-primary">Enter State </label>
							<input type="text" name="sta" id="sta" required placeholder="Type Here" class="form-control input-sm">
						</div>
						<div class="form-group">
							<label class="control-label text-primary">Enter city name </label>
